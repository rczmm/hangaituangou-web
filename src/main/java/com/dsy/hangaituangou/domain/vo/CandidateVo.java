...
public class CandidateVo {
    ...
    private List<AppliedJobVo> appliedJobs;
    
    @Schema(description = "简历文件信息")
    private ResumeFileVo resumeFile;
    
    @Schema(description = "面试安排信息")
    private InterviewScheduleVo interviewSchedule;
    
    @Data
    @Schema(description = "应聘岗位信息展示对象")
    public static class AppliedJobVo {
    ...
    @Data
    @Schema(description = "简历文件信息展示对象")
    public static class ResumeFileVo {
    ...
    @Data
    @Schema(description = "面试安排信息展示对象")
    public static class InterviewScheduleVo {
